		...
		value: function isHover(moreProps) {
			...
			if ((0, _utils.isDefined)(onHover)) {
				...
				if ((0, _utils.isDefined)(line1) && (0, _utils.isDefined)(line2)) {
					...
					const minX = xScale(lines.line1.x1) > xScale(lines.line1.x2) ? xScale(lines.line1.x2) : xScale(lines.line1.x1) 
					const minY = yScale(lines.line1.y1) > yScale(lines.line2.y1) ? yScale(lines.line2.y1) : yScale(lines.line1.y1)
					const maxX = xScale(lines.line1.x1) > xScale(lines.line1.x2) ? xScale(lines.line1.x1) : xScale(lines.line1.x2)
					const maxY = yScale(lines.line1.y1) > yScale(lines.line2.y1) ? yScale(lines.line1.y1) : yScale(lines.line2.y1)
					return _props.isHoverInside 
					? (mouseXY[0] <= maxX && mouseXY[0] >= minX && mouseXY[1] <= maxY && mouseXY[1] >= minY) :
					 (line1Hovering || line2Hovering);
