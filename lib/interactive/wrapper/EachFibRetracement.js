		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				lines.map(function (line, j) {
					...
					var colors = ['#2962FF', '#787B86', '#64B5F6', '#009688', '#4CAF50', '#F44336']
					return _react2.default.createElement(
						"g",
						{ key: j },
						_react2.default.createElement(_ChannelWithArea2.default, _extends({
							ref: _this2.saveNodeType("channel" + j),
							selected: selected || hover

						}, hoverHandler, {
							startXY: [line.x1, line.y - 2],
							endXY: [line.x2, line.y + 2],
							dy: j === 0 ? (line.y - 4) : (lines[j-1].y - line.y - 4),
							stroke: stroke,
