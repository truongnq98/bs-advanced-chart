...
var _EachTargetStop = require("./wrapper/EachTargetStop");

var _EachTargetStop2 = _interopRequireDefault(_EachTargetStop);
...
var TargetStop = function (_Component) {
	_inherits(TargetStop, _Component);

	function TargetStop(props) {
		_classCallCheck(this, TargetStop);

		var _this = _possibleConstructorReturn(this, (TargetStop.__proto__ || Object.getPrototypeOf(TargetStop)).call(this, props));
	...
	_createClass(TargetStop, [{
		...
		value: function handleStart(xyValue) {
			...
			if ((0, _utils.isNotDefined)(current) || (0, _utils.isNotDefined)(current.startXY)) {
				...
				this.setState({
					current: {
						startXY: xyValue,
						endXY: [xyValue[0] + 80, xyValue[1]],
						dy: 0,
						dLong: xyValue[1] * percent,
						dShort: - xyValue[1] * percent
					}
				}, function () {
		...
		value: function render() {
			...
			var tempChannel = (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.endXY) ? _react2.default.createElement(_EachTargetStop2.default, _extends({
				interactive: false
			}, current, {
				appearance: appearance,
				hoverText: hoverText
			...
			return _react2.default.createElement(
				...
				channels.map(function (each, idx) {
					...
					return _react2.default.createElement(_EachTargetStop2.default, _extends({
						key: idx,
						ref: _this5.saveNodeType(idx),
						index: idx,
						selected: each.selected,
						hoverText: hoverText,
						priceFormat: _props2.priceFormat,
						percentFormat: _props2.percentFormat,
						nightMode: _props2.nightMode,
...
exports.default = TargetStop;
//# sourceMappingURL=TargetStop.js.map